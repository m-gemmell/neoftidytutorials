...
- __Structure:__ The features of tibbles
- __Subsetting:__ How to subset tibbles similar to data.frames
- __Printing or viewing:__ How tibbles are displayed/printed in R
- __Adding rows and columns:__ Brief intro to adding new rows and columns to a tibble

[Tidyverse Tibble page](https://neof-workshops.github.io/Tidyverse/tibble/tibble.html)

### Overview

A __tibble__ (`tbl`) is a reimagining of the __data.frame__ (`df`) object. They are described as __data.frames__ that are:

- __Lazy__: They don’t change variable names and partial matching does not work
...
Other tutorials will not use `print()` and the __tibbles__ will then be shown as fully interactive tables.
...
You will need to use the pre made code and the guidance on the below link to carry out the exercises.

[Creating tibbles page](https://neof-workshops.github.io/Tidyverse/tibble/creating_tibbles.html)
...
__Tip:__ Remember to use `print()` to print your __tibble__.
...
Complete the below code by converting the __data.frame__ (`iris`) into a __tibble__ and printing it.
...
__Tibbles__ have a similar format to __data.frames__ but with some extra functionality and terminology.
...
For more details on the __tibble__ structure and to see how they are normally presented please see the below link:

[Tibbles structure page](https://neof-workshops.github.io/Tidyverse/tibble/structure.html)
...
- `tbl[rows,columns]`: This always produces a __tibble__
  - Numbers can be used to  represent row or column indexes
  - Strings can be used for columns based on their names
  
For more details and help for the following exercises please see the below link:

[Tibbles subsetting page](https://neof-workshops.github.io/Tidyverse/tibble/subsetting.html)

### Subsetting exercises

For the exercises we'll use the tibble `mgrtibbles::mammal_sleep_tbl` which contains information on the average sleep amounts of various mammals.

```{r pie-crab-subset, echo=FALSE}
...
mammal_sleep_tbl$brain_wt[1:4]
```

### Extract with `[,]`

Print the element in row 1 and column 2 as a tibble.
...
Print rows 2 to 4 and columns 9 to 11.
...
Print the columns of `body_wt` and `life_span`".
...
When viewing/printing a __tibble__ only a part of the __tibble__ will be displayed if its too wide (columns) or long (rows).
...
- __Width:__ The terminal will only show as many columns as it has room for
  - The number of columns depends on the width of the columns (i.e. 10 narrow columns may fit where only 5 wide wolumns could fit)
- __Length:__ By default a maximum of 10 rows will be displayed

For more detail please see:

[Tibbles printing or viewing page](https://neof-workshops.github.io/Tidyverse/tibble/printing.html)
...
If you are interested in more please see the below link:

[Tibbles adding rows or columns page](https://neof-workshops.github.io/Tidyverse/tibble/add_rows_and_columns.html)
