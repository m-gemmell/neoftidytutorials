...
Please use our siet as a reference and feel free to copy, paste, and edit the code from it.
...
- Change the layer from a histogram to a frequency polygon
...
- Change the layer from a normal line chart to a __steps__ line chart
...
- Facet grid the plot by rows using the `Sex` variable
- Scale transform the y axis by log10
...
- Make the x axis labels dodge each 
- Remove rows where `Height` is equal to 0
- Change the __color__ aesthetic to `Age`
- [Facet](https://neof-workshops.github.io/Tidyverse/ggplot2/facet.html) grid the plot by rows using the `Sex` variable
- [Scale transform](https://neof-workshops.github.io/Tidyverse/ggplot2/scale_values.html) the y axis by log10, setting 3 rows for dodging
  - See our [`tidyverse` Guides page](https://neof-workshops.github.io/Tidyverse/ggplot2/guides.html)

```{r boxplot-extra-exercise, exercise=TRUE, exercise.eval=FALSE, out.width="100%", fig.height=6}
amphibian_div_tbl |>
