...
They will need bacticking/quoting in `tidyvers` functions.
...
<center>![](./images/dplyr_arrange.png){style="width:150px"} ![](./images/dplyr_distinct.png){style="width:150px"}</center>

<center>![](./images/dplyr_filter.png){style="width:150px"} ![](./images/dplyr_slice.png){style="width:150px"}</center>
...
<center>![](./images/dplyr_glimpse.png){style="width:150px"} ![](./images/dplyr_select.png){style="width:150px"} ![](./images/dplyr_mutate.png){style="width:150px"}</center>

<center>![](./images/dplyr_pull.png){style="width:150px"} ![](./images/dplyr_relocate.png){style="width:150px"} ![](./images/dplyr_rename.png){style="width:150px"}</center>
...
It is a lot but the main website will act as a "cookbook for your future reference. I find it hard myself to remember the names of the functions and how they all work so I constantly refer to it as I carry otu my R coding.
